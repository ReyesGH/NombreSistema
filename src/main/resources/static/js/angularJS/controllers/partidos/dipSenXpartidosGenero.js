...
app.service("dipSenXpartidosGeneroService", ["$q", "$timeout",'$http',
  function dipSenXpartidosGeneroService($q, $timeout,$http) {
...
app.controller("dipSenXpartidosGeneroCtrl", ["$scope","$rootScope", "$uibModal", "dipSenXpartidosGeneroService", "DTOptionsBuilder", "DTColumnBuilder" ,'$stateParams',
  function dipSenXpartidosGeneroCtrl($scope,$rootScope, mo, dipSenXpartidosGeneroService,DTOptionsBuilder, DTColumnBuilder,$stateParams) {

	$scope.idPartido=$stateParams["idPartido"];
	$scope.idInstancia=$stateParams["idInstancia"];	
	$scope.genero=$stateParams["genero"];	
    ...
    this.$onInit = function () {
    	dipSenXpartidosGeneroService.getPartido($scope.idInstancia,$scope.idPartido)
   ...
   var dt = this;
    ...
    dt.persons = {};
      dt.options = DTOptionsBuilder
        .fromSource("/SilPortal/REST/Legislador/getLegisladores/"+$scope.idInstancia+"/partido/"+$scope.idPartido+'/genero/'+$scope.genero)
